[README.md](https://github.com/user-attachments/files/30468726/README.md)
# README.md — Nexus
...
│       │   ├── services/
│       │   │   ├── nexus/   ← motor principal de IA
│       │   │   ├── interview/ ← subsistema de recolección de datos
...
con tool calls, subsistema de entrevistas v2, integración WhatsApp, eventos, 
notificaciones, tests exhaustivos). El panel admin está en construcción activa.
Ver MODULOS.md para el estado detallado por módulo.
