  ...
  categories.forEach(cat => {
    ...
    const card = createElement('div', { className: 'category-card' }, [
      ...
      createElement('div', { className: 'services-list' },
        catServices.map(s => createElement('div', { className: 'service-item' }, [
...
export function renderPromotions(promotions) {
  ...
  promotions.forEach(promo => {
    ...
    const card = createElement('div', { className: 'promo-card' }, [
...
export function renderPrint3d(printData) {
  ...
  printData.forEach(item => {
    const card = createElement('div', { className: 'print3d-card' }, [
